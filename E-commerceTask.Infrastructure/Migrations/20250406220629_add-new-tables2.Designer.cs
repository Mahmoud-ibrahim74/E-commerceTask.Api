...
namespace E_commerceTask.Infrastructure.Migrations
{
    ...
    [Migration("20250406220629_add-new-tables2")]
            ...
            modelBuilder.Entity("E_commerceTask.Domain.Models.Orders.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            id = 1,
                            customer_id = 1,
                            order_date = new DateTime(2025, 4, 7, 0, 0, 0, 0, DateTimeKind.Local),
                            status = "Pending",
                            total_price = 1570.0
                        },
                        new
                        {
                            id = 2,
                            customer_id = 2,
                            order_date = new DateTime(2025, 4, 5, 0, 0, 0, 0, DateTimeKind.Local),
                            status = "Delivered",
                            total_price = 95.0
                        });
                });
